...
import { Router, Network, Shield } from "lucide-react";
    ...
    <div className="flex flex-1 h-[calc(100vh-4rem)]">
      <div className="w-64 border-r p-4 space-y-2 overflow-y-auto">
        <button
          ...
          className="w-full mb-4 rounded-md bg-blue-600 text-white p-2 hover:bg-blue-700 transition"
        >
          + Dodaj urządzenie
        </button>
        ...
        {devices.map((device) => (
          <button
            ...
            className={`w-full text-left rounded-md border p-2 hover:bg-gray-100 transition ${
              selectedDevice?.id === device.id ? "bg-blue-50 border-blue-500" : ""
            }`}
          >
